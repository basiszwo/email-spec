= Email Spec (somewhen Email Test)

A collection of (RSpec) Test::Unit matchers and Cucumber steps to make testing emails go smoothly.
...
=== Requirements
  ...
  jnunemaker-matchy for having the ability to create custom matchers and use some shipped matchers like should in Test::Unit

=== Gem Setup
  
  gem install basiszwo-email_spec

  # config/environments/test.rb
  config.gem 'basiszwo-email_spec', :lib => 'email_spec'
